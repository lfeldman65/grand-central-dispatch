...
export async function testForNotificationPre(
  ...
  if (weeklyGoal == 0 && weeklyNum == 0) {
    ...
    scheduleNotifications('win-notification', 'Congratulations! 🏆', 'You Won the Week for ' + newGoalName + '!', 1);
  } else if (weeklyGoal != 0 && weeklyNum == weeklyGoal - 1) {
    scheduleNotifications('win-notification', 'Congratulations! 🏆', 'You Won the Week for ' + newGoalName + '!', 1);
  } else if (dailyGoal == 0 && dailyNum == 0) {
    scheduleNotifications('win-notification', 'Congratulations! 🏆', 'You Won the Day for ' + newGoalName + '!', 1);
